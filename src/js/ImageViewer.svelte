...
<sl-resize-observer bind:this={resizeObserver} on:sl-resize={onResize}>
  <div class="viewer--container" bind:this={viewerEl} on:fullscreenchange={onFullscreenChange}>
    {#if initialized}
    <ImageViewerHeader {manifest} {hasPageText} {buttons} bind:panelTabs={panelTabs} {toggleFullscreen} {viewerWidth}>
      <sl-tooltip content={isFullscreen ? 'Exit fullscreen' : 'Toggle fullscreen'} slot="fullscreen">
        <button 
          type="button" 
